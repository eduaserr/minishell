...
/*   Updated: 2025/07/08 19:18:40 by aamoros-         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
//	builtin.c		//
//////////////////////
bool							execute_parent_builtin(char **cmd_args,
									t_shell *shell);
void							execute_child_builtins(char **cmd_args,
									t_shell *shell);
...
//	cmd.c			//
//////////////////////
t_cmd							*get_cmd(t_shell *shell, t_cmd *cmd,
									char *input, int pipe);
...
//	execute.c		//
//////////////////////
void							exec_cmd(t_shell *shell, char **cmd_args,
									char **env);
...
t_redir							*redir_node(t_shell *mshell, t_token *tkn,
									t_redir *lstrd, int cmd_ix);

//////////////////////
//	init_tkn.c		//
//////////////////////
t_token							*get_token(t_token *new, t_token_type tkn,
									char *value, int *i);
void							addlast_tknnode(t_token **token_list,
									t_token *node);
...
//	quotes_expand.c	//
//////////////////////
void							dollar_case(t_env *env, int e_status,
									char **str);
...
void							ft_error_exit(t_shell **mshell, char *message,
									int code);

//////////////////////
//	utils_expand.c	//
//////////////////////
void							swp_value(char **input, char *value, int i,
									int end);
